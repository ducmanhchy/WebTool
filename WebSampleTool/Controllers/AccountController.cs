...
namespace WebSampleTool.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Xác nhận tài khoản", "Xác nhận tài khoản của bạn bằng cách bấm vào <a href=\"" + callbackUrl + "\">Đây</a>");
        ...
        {
            return string.IsNullOrEmpty(Code) || string.IsNullOrEmpty(UserId) ? PartialView("InternalServerError") : PartialView();
        }
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return RedirectToAction("Login", new { Message = "ChangePasswordSuccess" });
            }
        ...
        //{
        //    // Yêu cầu người dùng đã đăng nhập bằng username/password hoặc đăng nhập từ bên ngoài
